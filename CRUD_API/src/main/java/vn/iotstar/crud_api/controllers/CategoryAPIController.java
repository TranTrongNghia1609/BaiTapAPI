package vn.iotstar.crud_api.controllers;
...
import vn.iotstar.crud_api.model.Response;
import vn.iotstar.crud_api.service.ICategoryService;
...
public class CategoryAPIController {
    ...
    public ResponseEntity<?> addCategory(@Validated @RequestParam("categoryName")
        ...
        Optional<Categories> optCategory = categoryService.findByCategoryName(categoryName);
...
//return ResponseEntity.ok().body(category);
    ...
    public ResponseEntity<?> updateCategory(@Validated @RequestParam("categoryId")
                                            ...
                                            @Validated @RequestParam("icon") MultipartFile icon) {
        Optional<Categories> optCategory = categoryService.findById(categoryId);
